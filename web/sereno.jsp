...
<%
    if (session.getAttribute("rol") == null || !session.getAttribute("rol").equals("sereno")) {
...
<head>
    <meta charset="UTF-8">
    <title>Panel del Sereno - INFRA REPORT</title>
        ...
        <div class="col-md-3">
            <div class="card">
                <div class="card-header bg-primary-custom text-white">
                    <h5 class="mb-0"><i class="bi bi-menu-button-wide"></i> Panel Sereno</h5>
                </div>
